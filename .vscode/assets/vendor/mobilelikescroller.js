class MobileLikeScroller {
    ...
    inertialmove() {
        ...
        if (av0 == 0 || v <= 0 || isNaN(av0)) {
            ...
            // modificacion para darle mas inercia
            // que miedo todo esto
            var modificador = 5 // 0 = valor original, a mayor numero mas inercia...
            var deltaY = ($(this.target).height()*unitVector[1] * (av0 * t - 7.1397 * t * t + 25.08 * t * t * t / av0 - 37.43 * t * t * t * t / av0 / av0)) / modificador;
